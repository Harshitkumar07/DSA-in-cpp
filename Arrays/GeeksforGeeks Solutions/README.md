...
- **Sorting and Searching**  
  - **Binary Search Variants** (e.g., finding the first and last position of an element, or search in a rotated sorted array)
  - **Sorting Algorithms** (e.g., QuickSort, MergeSort, and HeapSort)
  - **Custom Sorting Problems** (e.g., sorting by frequency or in a zig-zag pattern)
